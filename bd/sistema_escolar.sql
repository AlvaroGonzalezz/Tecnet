...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-03-2026 a las 22:58:27
...
INSERT INTO `administrativo` (`id_administrativo`, `nombre`, `apellido`, `telefono`, `correo`, `area`) VALUES
(1, 'Laura Fernanda', 'Martinez Lopez', '8712223344', 'laura.martinez@tecnologico.edu.mx', 'Control Escolar'),
(3, 'Nestor', 'Isidro Perez', NULL, 'nestor@tecsanpedro.edu.mx', 'Vinculacion'),
(4, 'Ulises', 'Martinez Rodriguez', NULL, 'ulises@tecsanpedro.edu.mx', NULL),
(7, 'Ulises', 'Martinez Rodriguez', NULL, 'ulises2@tecsanpedro.edu.mx', NULL),
(9, 'Ulises', 'Martinez Rodriguez', NULL, 'ulises23@tecsanpedro.edu.mx', NULL);
...
(3, 'alvaro@gmail.com2', 'SAGA1241231232A', 1, 'Alvaro2', 'Sánchez González2', '87212412312', '2000-01-01', 'Av. 213', NULL, '2026-03-17');
...
INSERT INTO `docente` (`id_docente`, `nombre`, `apellido`, `telefono`, `correo`, `id_director`) VALUES
(1, 'Miguel Angel', 'Hernandez Soto', '8715558899', 'miguel.hernandez@tecnologico.edu.mx', 1),
(2, 'Alvaro', 'Sánchez González', '123123123', 'alvaro@tecsanpedro.edu.mx', NULL);
...
(3, 'nestor@tecsanpedro.edu.mx', '$2y$10$hds4/edKtMBHxBtsimJ31.KoxEF9nq9o7/MuoIeJX9yDEj5bebR4C', 1, NULL, NULL, 3),
...
(10, 'alvaro@tecsanpedro.edu.mx', '$2y$10$B0XlcSAwnRnrFdQXTHdfrOJlYu.pFiT0O2lq3.6mD5U1uHj2NcHcq', 3, 2, NULL, NULL);
...
--
ALTER TABLE `administrativo`
  MODIFY `id_administrativo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `aspirantes`
  MODIFY `id_aspirante` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
