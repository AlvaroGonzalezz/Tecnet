...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-03-2026 a las 05:02:03
...
(13, 'Ernesto', 'Zambada Ortiz', '8723124123', '1774141768_ernesto@tecsanpedro.edu.mx.jpg', 'ernesto@tecsanpedro.edu.mx', 'Control Escolar');
...
(2, 'Alfredo', 'Salazar Escobar', 'SAGA040905HCLNNLA1', '2000-01-01', 'Av. Margaritas Col. San Isidro SP', '87212412315', 'alfredo@gmail.com', 'default.png', 'Activo', NULL, 3, 1, NULL),
(3, 'Ovidio', 'Lopez Franco', 'OLF70101', '2000-03-01', 'Av. Tecnologico San Pedro Coah.', '8412312412', 'ovidio@gmail.com', 'default.png', 'Activo', NULL, 4, 3, NULL);
...
(6, 'sofia@gmail.com', 'SOFI010101', 2, 'Sofia', 'Ortiz Avalos', '8712412512', '2008-01-01', 'Av Del Valle #150 San Pedro Coah.', 'default.png', '2026-03-24');
...
(2, 2, 1, 100.00, 90.00, 80.00, 70.00, NULL, NULL, NULL, NULL, 85.00),
(9, 2, 5, 100.00, 90.00, 70.00, NULL, NULL, NULL, NULL, NULL, 86.67);
...
INSERT INTO `carga_academica` (`id_carga`, `id_alumno`, `semestre`, `archivo_pdf`, `observaciones`, `fecha_subida`, `id_usuario_subio`) VALUES
(2, 2, 4, 'Carga_2_1774162440.pdf', 'Acude a la oficina del jefe de tu carrera', '2026-03-22 00:54:00', 15);
...
(5, 'Pedro', 'Barajas Pedroza', '8712412314', '1774142130_docente.jpg', 'pedro@tecsanpedro.edu.mx', NULL),
(6, 'Isidro', 'Mendoza Ortiz', '8441234512', '1774142229_docente.webp', 'isidro@tecsanpedro.edu.mx', NULL);
...
(5, NULL, 'documentos_aspirantes/SOFI010101/1774310717_comprobante.webp', 'SOFI010101', 'documentos_aspirantes/SOFI010101/1774310717_Rocka1.jpg', 'documentos_aspirantes/SOFI010101/1774310717_comprobante.webp');
...
INSERT INTO `grupo` (`id_grupo`, `semestre`, `id_carrera`) VALUES
(1, 1, 1),
(3, 4, 1),
(4, 2, 2),
(5, 6, 4);
...
INSERT INTO `materias` (`id_materia`, `nombre_materia`, `semestre`, `creditos`, `id_docente`) VALUES
(1, 'Fundamentos de Programación', 1, 8, 6),
(4, 'Arquitectura de Computadoras', 4, 5, 4),
(5, 'Programación Orientada a Objetos', 4, 5, 6);
...
(15, 'nestor@tecsanpedro.edu.mx', '$2y$10$UjKs0fp/c36nx6b76qOIXOBi1ij2sHVuqxtywve0bjXw7AUA8bAAS', 1, NULL, NULL, 12),
...
(18, 'ernesto@tecsanpedro.edu.mx', '$2y$10$vdp2BSpvNSldMlF6O8/xZOcQRBnjoB/EcS5fnNW1e1Kc1XbAG2Ae2', 1, NULL, NULL, 13),
(19, 'pedro@tecsanpedro.edu.mx', '$2y$10$mrrn/4GdMZG6hGa7t4PH3OEH04iLUgEWnAWkcW2wqbUDbqbBO7wWW', 3, 5, NULL, NULL),
(20, 'isidro@tecsanpedro.edu.mx', '$2y$10$SfqZhZbKC1.4HibhUQR45OeTpv88n2d8Ju9zUTE.vgr0LrZKBrdYG', 3, 6, NULL, NULL);
...
--
ALTER TABLE `administrativo`
  MODIFY `id_administrativo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `aspirantes`
  MODIFY `id_aspirante` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `carga_academica`
  ADD CONSTRAINT `carga_academica_ibfk_1` FOREIGN KEY (`id_alumno`) REFERENCES `alumno` (`id_alumno`);
COMMIT;
