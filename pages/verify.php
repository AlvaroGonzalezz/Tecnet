    ...
    if ($usuario = $resultado->fetch_assoc()) {
        ...
        if (password_verify($password, $usuario['contraseña'])) {
            ...
            switch ($usuario['id_rol']) {
                case 1:
                    header("Location: ../portal/dashboard_admin.php");
                    break;
                case 2:
                    header("Location: ../portal/dashboard_alumno.php");
                    break;
                case 3:
                    header("Location: ../portal/dashboard_docente.php");
                    break;
                case 4:
